...
import { z } from "zod";
import {
  Calendar, Wallet, ShieldCheck, LayoutGrid, Store,
  Maximize2, BookmarkCheck,
} from "lucide-react";
    ...
    fetch(`/api/warranties/${id}`)
      ...
      .then((w) => {
        ...
        const closest = WARRANTY_OPTIONS.reduce((prev, cur) =>
          Math.abs(cur.value - w.warrantyMonths) < Math.abs(prev.value - w.warrantyMonths) ? cur : prev
        );
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      <header className="px-4 py-4 flex items-center gap-3">
        <button onClick={() => router.back()} className="text-foreground">←</button>
      ...
      <main className="max-w-lg mx-auto px-4 space-y-5">
        ...
        {receiptUrl && (
          <section className="space-y-2">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase">Receipt Preview</p>
            <div className="relative rounded-2xl overflow-hidden border">
              <iframe src={receiptUrl} className="w-full" style={{ height: 260 }} title="Receipt" />
              <a
                href={receiptUrl}
                target="_blank"
        ...
        <section className="space-y-2">
          <div className="flex items-center justify-between">
            <p className="text-xs font-semibold tracking-widest text-muted-foreground uppercase">Extracted Details</p>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="bg-card rounded-2xl border divide-y">
              ...
              <div className="p-4 space-y-1.5">
                ...
                <input {...register("productName")} placeholder="e.g. iPhone 15 Pro"
              ...
              <div className="p-4 space-y-1.5">
                ...
                <FieldRow icon={Store}>
                  <input {...register("storeName")} placeholder="e.g. Apple Malaysia"
              ...
              <div className="p-4 space-y-1.5">
                ...
                <FieldRow icon={Wallet}>
                  <div className="flex items-center gap-2">
                    ...
                    <input type="number" step="0.01" min={0} {...register("priceMyr", { valueAsNumber: true })}
                      placeholder="0.00" className="flex-1 text-sm bg-transparent outline-none" />
                  </div>
                </FieldRow>
              </div>
              ...
              <div className="p-4 space-y-1.5">
                ...
                <FieldRow icon={ShieldCheck}>
                  <Controller name="warrantyMonths" control={control} render={({ field }) => (
